...
Types: TypesScript-এ types হলো ডেটার type বা structure নির্ধারণ করার একটি আরও অধিকতর ব্যাপক একটি উপায়। Types ও interfaces এর মত ডেটার type ঘোষণা করতেও ব্যবহৃত হয়, তবে এর ব্যবহারক্ষেত্র interfaces-এর তুলনায় আরও বিস্তৃত।
